...
const categoryButtons = document.getElementById("category-buttons").querySelectorAll("button");
...
categoryButtons.forEach(btn => {
    btn.addEventListener("click", () => {
        ...
        if (category === "all") {
            renderRecipes(additionalRecipes);
        } else {
            const filtered = additionalRecipes.filter(r => r.category === category);
